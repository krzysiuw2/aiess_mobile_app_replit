...
Run: 2026-07-03T09:20:03.798Z  |  Backend: compat shim target `ddb`  |  Base: https://jyjbeg4h9e.execute-api.eu-central-1.amazonaws.com/default
...
- PASS — sch is object
- PASS — metadata counts present — {"last_sync":"2026-07-03T08:05:30Z","rule_count":5,"version":53,"total_rules":5,"local_rules":0,"cloud_rules":5,"scada_safety_rules":0}
- PASS — safety SoC serialized as integers (raw text)
- PASS — metadata.cloud_rules + scada matches visible rules or documented split — visible p4-9=5, metadata={"last_sync":"2026-07-03T08:05:30Z","rule_count":5,"version":53,"total_rules":5,"local_rules":0,"cloud_rules":5,"scada_safety_rules":0}
- PASS — all rules parse for the editor
- PASS — read-only bands visible in GET (matches metadata) — visible=0, metadata local+scada=0

### 2. Round-trip per action type (ch, dis, ct, threshold)

- PASS — save accepted — status 200: {"message": "Updated: schedules", "site_id": "domagala_1", "shadow_version": 54, "updated_priorities": [5], "total_rules": 4}
...
- PASS — sl write accepted — status 200: {"message": "Updated: schedules", "site_id": "domagala_1", "shadow_version": 59, "updated_priorities": [9], "total_rules": 1}
- PASS — sl round-trips — {"hth":71,"lth":-47,"t":"sl"}
- PASS — single sl rule in p_9
- PASS — original p_9 restored — now: {"hth":70,"lth":-48,"t":"sl"}, want: {"t":"sl","lth":-48,"hth":70}
...
- PASS — mode POST accepted — status 200: {"message": "Updated: mode", "site_id": "domagala_1", "shadow_version": 0, "updated_priorities": [], "total_rules": 0}
- PASS — mode reads back as automatic — mode=automatic
- PASS — mode restored to semi-automatic — mode=semi-automatic

### 6. AI rule auto-expiry (s:"ai" + vu = now+5min)

- PASS — skipped (--skip-expiry)
