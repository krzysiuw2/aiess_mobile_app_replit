# DDB regression report — olmar_1

Run: 2026-07-03T09:26:01.653Z  |  Backend: compat shim target `ddb`  |  Base: https://jyjbeg4h9e.execute-api.eu-central-1.amazonaws.com/default
...
| 10. Mode round-trip (automatic <-> semi-automatic) | PASS |
...
- PASS — has mode — mode=automatic
- PASS — safety present — {"soc_min":1,"soc_max":100}
- PASS — sch is object
- PASS — metadata counts present — {"last_sync":"2026-07-03T08:34:55Z","rule_count":7,"version":7,"total_rules":7,"local_rules":1,"cloud_rules":6,"scada_safety_rules":0}
- PASS — safety SoC serialized as integers (raw text)
- PASS — metadata.cloud_rules + scada matches visible rules or documented split — visible p4-9=6, metadata={"last_sync":"2026-07-03T08:34:55Z","rule_count":7,"version":7,"total_rules":7,"local_rules":1,"cloud_rules":6,"scada_safety_rules":0}
- PASS — all rules parse for the editor
- PASS — read-only bands visible in GET (matches metadata) — visible=1, metadata local+scada=1

### 2. Round-trip per action type (ch, dis, ct, threshold)

- PASS — save accepted — status 200: {"message": "Updated: schedules", "site_id": "olmar_1", "shadow_version": 8, "updated_priorities": [5], "total_rules": 4}
...
- PASS — POST accepted — status 200: {"message": "Updated: safety", "site_id": "olmar_1", "shadow_version": 0, "updated_priorities": [], "total_rules": 0}
...
- PASS — sl write accepted — status 200: {"message": "Updated: schedules", "site_id": "olmar_1", "shadow_version": 13, "updated_priorities": [9], "total_rules": 1}
- PASS — sl round-trips — {"t":"sl","hth":71,"lth":-47}
- PASS — single sl rule in p_9
- PASS — original p_9 restored — now: {"lth":-40,"t":"sl","hth":140}, want: {"hth":140,"t":"sl","lth":-40}
...
- PASS — site_id echoes
- PASS — has expected top-level sections — automation,battery,created_at,financial,general,grid_connection,inverter,load_profile,location,power_limits,pv_system,site_id,updated_at

### 10. Mode round-trip (automatic <-> semi-automatic)

- PASS — mode POST accepted — status 200: {"message": "Updated: mode", "site_id": "olmar_1", "shadow_version": 0, "updated_priorities": [], "total_rules": 0}
- PASS — mode reads back as semi-automatic — mode=semi-automatic
- PASS — mode restored to automatic — mode=automatic

### 6. AI rule auto-expiry (s:"ai" + vu = now+5min)

- PASS — ai rule accepted — status 200: {"message": "Updated: schedules", "site_id": "olmar_1", "shadow_version": 19, "updated_priorities": [4], "total_rules": 1}
